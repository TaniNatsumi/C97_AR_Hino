...
window.onload = function () {
	...
	function loadAssets() {
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/C97_Hino/C97_Hino.model3.json", xhrType);
			loader.add('motion1', "assets/C97_Hino/motions/C97_Hino1.motion3.json", xhrType);
			loader.add('motion2', "assets/C97_Hino/motions/C97_Hino1.motion3.json", xhrType);
